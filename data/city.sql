...
COMMENT = 'Timezone offcet by city for 3 moths';

ALTER TABLE cityZone
ADD UNIQUE INDEX UK_cityZone (cityId, date);
...
on duplicate key update id=id,country_iso3=country_iso3,name=name,latitude=latitude,longitude=longitude
;
insert into ft_extra.city (id,country_iso3,name,latitude,longitude) values
